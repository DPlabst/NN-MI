...
> [!NOTE] Running [example1a_nnmi_v1.0.py](example1a_nnmi_v1.0.py) and
...
> [!NOTE] Running [example2a_nnmi_v1.0.py](example2a_nnmi_v1.0.py) computes achievable information rates for the above model. The equivalent discrete system model is a memoryless channel with c.s. AWGN: 
>
> $$ Y = X + N $$
> 
